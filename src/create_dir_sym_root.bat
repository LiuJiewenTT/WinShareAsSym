...
@echo.
@echo Usage: create_dir_sym_root.bat file1 [file2 file3...]
@echo.
@echo Example: create_dir_sym_root.bat "F:\My Documents\Learning\Python" "E:\My Music\Rock"
@echo.
@echo This will create two relative symlinks, "Python" and "Rock", in the current directory. One for "F:\My Documents\Learning\Python" and one for "E:\My Music\Rock". Paths start with '\' separator.
@echo.
...
mklink /D "%~dp0%source_filename%" "%retv%"
shift /1
